...
import (
	dpfm_api_caller "data-platform-api-inspection-lot-mill-sheet-pdf-generates-rmq-kube/DPFM_API_Caller"
	dpfm_api_input_reader "data-platform-api-inspection-lot-mill-sheet-pdf-generates-rmq-kube/DPFM_API_Input_Formatter"
	dpfm_api_output_formatter "data-platform-api-inspection-lot-mill-sheet-pdf-generates-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-inspection-lot-mill-sheet-pdf-generates-rmq-kube/config"
	"encoding/base64"
	"encoding/json"
	"fmt"
	"os"
